namespace Predict.Migrations
{
    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    CreatedByPlayerId = c.String(maxLength: 128),
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.Players", t => t.CreatedByPlayerId)
                .Index(t => t.CreatedByPlayerId);
            ...
            CreateTable(
                ...
                c => new
                {
                    ...
                    ShortLeagueName = c.String(nullable: false, maxLength: 15),
            ...
            CreateTable(
                "dbo.EventPoolPlayerPositionHistory",
                c => new
                {
                    EventId = c.Short(nullable: false),
                ...
                .PrimaryKey(t => new { t.EventId, t.PoolId, t.PlayerId, t.PositionDate })
                .ForeignKey("dbo.EventPoolPlayers", t => new { t.EventId, t.PoolId, t.PlayerId }, cascadeDelete: true)
                .Index(t => new { t.EventId, t.PoolId, t.PlayerId });

            CreateTable(
                "dbo.EventPoolPlayers",
                c => new
                {
                    EventId = c.Short(nullable: false),
                    PoolId = c.Int(nullable: false),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.EventPoolPlayerPositionHistory", new[] { "EventId", "PoolId", "PlayerId" }, "dbo.EventPoolPlayers");
            DropForeignKey("dbo.EventPoolPlayers", "PoolId", "dbo.Pools");
            DropForeignKey("dbo.Pools", "AdminPlayerId", "dbo.Players");
            DropForeignKey("dbo.EventPoolPlayers", "PlayerId", "dbo.Players");
            DropForeignKey("dbo.EventPoolPlayers", "EventId", "dbo.Events");
            ...
            DropForeignKey("dbo.Events", "CreatedByPlayerId", "dbo.Players");
            ...
            DropIndex("dbo.EventPoolPlayers", new[] { "PlayerId" });
            DropIndex("dbo.EventPoolPlayers", new[] { "PoolId" });
            DropIndex("dbo.EventPoolPlayers", new[] { "EventId" });
            DropIndex("dbo.EventPoolPlayerPositionHistory", new[] { "EventId", "PoolId", "PlayerId" });
            ...
            DropIndex("dbo.Events", new[] { "CreatedByPlayerId" });
            ...
            DropTable("dbo.Pools");
            DropTable("dbo.EventPoolPlayers");
            DropTable("dbo.EventPoolPlayerPositionHistory");
