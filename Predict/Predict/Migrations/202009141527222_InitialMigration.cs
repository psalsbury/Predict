    ...
    public partial class InitialMigration : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo.PoolPlayers", t => new { t.EventId, t.PoolId, t.PlayerId }, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.PoolPlayerPositionHistory", new[] { "EventId", "PoolId", "PlayerId" }, "dbo.PoolPlayers");
            ...
            DropIndex("dbo.PoolPlayerPositionHistory", new[] { "EventId", "PoolId", "PlayerId" });
