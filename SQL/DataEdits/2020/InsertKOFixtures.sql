...
SELECT @intEventId, '26 June 2021 17:00:00'           ,16,1  ,'A' ,2 ,'B' ,2 ,GETDATE() ,GETDATE()
UNION ALL SELECT @intEventId, '26 June 2021 20:00:00' ,16,2  ,'A' ,1 ,'C' ,2 ,GETDATE() ,GETDATE()
UNION ALL SELECT @intEventId, '27 June 2021 17:00:00' ,16,3  ,'C' ,1 ,'DEF' ,3 ,GETDATE() ,GETDATE()
UNION ALL SELECT @intEventId, '27 June 2021 20:00:00' ,16,4  ,'B' ,1 ,'ADEF' ,3 ,GETDATE() ,GETDATE()
UNION ALL SELECT @intEventId, '28 June 2021 17:00:00' ,16,5  ,'D' ,2 ,'E' ,2 ,GETDATE() ,GETDATE()
UNION ALL SELECT @intEventId, '28 June 2021 20:00:00' ,16,6  ,'F' ,1 ,'ABC' ,3 ,GETDATE() ,GETDATE()
UNION ALL SELECT @intEventId, '29 June 2021 17:00:00' ,16,7  ,'D' ,1 ,'F' ,2 ,GETDATE() ,GETDATE()
UNION ALL SELECT @intEventId, '29 June 2021 20:00:00' ,16,8  ,'E' ,1 ,'ABCD' ,3 ,GETDATE() ,GETDATE()
